 ...
 * @author sayee
 */
public class frmWindowsCommand extends javax.swing.JFrame {

    /**
     * Creates new form frmWindowsCommand
     */
    public frmWindowsCommand() {
        initComponents();
    }
...
Process process=pb.start();
    ...
    re. printStackTrace();
            ...
            Logger.getLogger(frmWindowsCommand.class.getName()).log(Level.SEVERE, null, ex);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmWindowsCommand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmWindowsCommand().setVisible(true);
            }
        });
    }
